...
//		int y = 1;
		...
		long currentCode = 27995004L;
//		long currentCode = 20151125L;
		...
		System.out.println("The code for the weather machine is: " + currentCode);
	}
	
	public static long generateCode(long codeBase) {
		int multiplier = 252533;
		int modulator = 33554393;
		
		return (codeBase * multiplier) % modulator;
	}
